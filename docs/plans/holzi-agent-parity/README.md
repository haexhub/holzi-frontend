...
Next up: [17 — Cline/Roo first-class channel](./17-cline-roo-first-class-channel.md) **or** [20 — Onboarding, diagnostics, and docs](./20-onboarding-diagnostics-docs.md). Plan 18 (Profiles/Spaces) is "do not implement unless a new need appears" per the recommended order; Plan 19 is the bigger production-hardening pass.
