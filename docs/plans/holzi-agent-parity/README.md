...
Next up: [14 — control-center shell](./14-control-center-shell.md) (frontend-only refactor of `/settings` into a Control Center shell with placeholder routes for the future panels), or jump to [15 — memory panel](./15-memory-panel.md) once the Control Center has a home for it.
